        ...
        <div className="row gx-5 ps-1">
          ...
          <div className="row gx-3">
            <div className="col bg-light-subtle border py-3 mx-3">
              <h3>Call <i class="bi bi-telephone-fill"></i></h3>
              <p className="fw-lighter fs-5">
                You can reach me directly through a phone call on the following
                number: <b><u> 067 1974 979</u></b> alternatively <b><u> 072 1997 807</u></b>
              </p>
            </div>
            <div className="col bg-light-subtle border py-3 mx-3">
              <h3>Email <i class="bi bi-envelope-fill"></i></h3>
              <p className="fw-lighter fs-5">
                Get in touch with me through email on the following address:
                 <b><u> mrlolwane96@gmail.com</u></b> and I will get back to you swiftly.
              </p>
            </div>
            <div className="col bg-light-subtle border py-3 mx-3">
              <h3>LinkedIn <i class="bi bi-linkedin"></i></h3>
              <p className="fw-lighter fs-5">
